    ...
    public function run(): void
    {
        $npcs = [
            ...
            [
                ...
                'avatar_name' => '07Kamachat', // 綁定對應的頭像變數
        ...
        foreach ($npcs as $npcData) {
            // 從設定好的 avatar_name 動態找尋頭像
            $avatar = Avatar::where('name', '=', $npcData['avatar_name'])->first();
            ...
            Npc::updateOrCreate(
                ...
                [
                    ...
                    'avatar_id' => $avatar?->id, // 如果有找到頭像就綁定
                    'location' => $npcData['location'],
                    'is_active' => $npcData['is_active'],
                ]
            );
        }
    }
